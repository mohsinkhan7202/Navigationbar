    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showStudentBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(ChooseDepartmentActivity.this,StudentDetailActivity.class);
        ...
        showTeacherBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String department=spinner.getSelectedItem().toString();
                Intent intent=new Intent(ChooseDepartmentActivity.this,TeacherDetailActivity.class);
                intent.putExtra("department",department);
                startActivity(intent);
            }
        });
    ...
    private void getData(){
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter<String> adapter=new ArrayAdapter<String>(ChooseDepartmentActivity.this,R.layout.support_simple_spinner_dropdown_item,depertments);
